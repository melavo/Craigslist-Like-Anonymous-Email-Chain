...
class MeekroDB {
  ...
  public function nonSQLError($message) {
    ...
    $error_handler = is_callable($this->nonsql_error_handler) ? $this->nonsql_error_handler : 'apidb_error_handler';
  ...
  protected function queryHelper() {
    ...
    if (!$sql || $db->error) {
      if ($this->error_handler) {
        $error_handler = is_callable($this->error_handler) ? $this->error_handler : 'apidb_error_handler';
      ...
      $success_handler = is_callable($this->success_handler) ? $this->success_handler : 'apidb_debugmode_handler';
...
function apidb_error_handler($params) {
...
function apidb_debugmode_handler($params) {
